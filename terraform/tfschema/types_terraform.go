			...
			Attributes: github_com_hashicorp_terraform_plugin_framework_tfsdk.SingleNestedAttributes(map[string]github_com_hashicorp_terraform_plugin_framework_tfsdk.Attribute{
				...
				"options": {
					Attributes: github_com_hashicorp_terraform_plugin_framework_tfsdk.SingleNestedAttributes(map[string]github_com_hashicorp_terraform_plugin_framework_tfsdk.Attribute{
						...
						"record_session": {
							Attributes:  github_com_hashicorp_terraform_plugin_framework_tfsdk.SingleNestedAttributes(map[string]github_com_hashicorp_terraform_plugin_framework_tfsdk.Attribute{"desktop": GenSchemaBoolOption(ctx)}),
							...
							if !ok {
								...
								if !v.Null && !v.Unknown {
									...
									}
									{
										...
										if !ok {
											diags.Append(attrReadMissingDiag{"AuthPreferenceV2.Spec.Webauthn.Disabled"})
										} else {
											v, ok := a.(github_com_hashicorp_terraform_plugin_framework_types.Bool)
											if !ok {
												diags.Append(attrReadConversionFailureDiag{"AuthPreferenceV2.Spec.Webauthn.Disabled", "github.com/hashicorp/terraform-plugin-framework/types.Bool"})
											} else {
												var t bool
												if !v.Null && !v.Unknown {
													t = bool(v.Value)
							...
							if !ok {
								...
								if obj.Webauthn == nil {
									...
									}
									{
										...
										if !ok {
											diags.Append(attrWriteMissingDiag{"AuthPreferenceV2.Spec.Webauthn.Disabled"})
										} else {
											v, ok := tf.Attrs["disabled"].(github_com_hashicorp_terraform_plugin_framework_types.Bool)
											if !ok {
												i, err := t.ValueFromTerraform(ctx, github_com_hashicorp_terraform_plugin_go_tftypes.NewValue(t.TerraformType(ctx), nil))
												if err != nil {
													diags.Append(attrWriteGeneralError{"AuthPreferenceV2.Spec.Webauthn.Disabled", err})
												}
												v, ok = i.(github_com_hashicorp_terraform_plugin_framework_types.Bool)
												if !ok {
			...
			if !ok {
				...
				if !v.Null && !v.Unknown {
					...
					}
					{
						...
						if !ok {
							diags.Append(attrReadMissingDiag{"OIDCConnectorV3.Spec.RedirectURL"})
						} else {
							v, ok := a.(github_com_hashicorp_terraform_plugin_framework_types.String)
							if !ok {
								diags.Append(attrReadConversionFailureDiag{"OIDCConnectorV3.Spec.RedirectURL", "github.com/hashicorp/terraform-plugin-framework/types.String"})
							} else {
								var t string
								if !v.Null && !v.Unknown {
									t = string(v.Value)
			...
			if !ok {
				...
				}
				{
					...
					}
					{
						...
						if !ok {
							diags.Append(attrWriteMissingDiag{"OIDCConnectorV3.Spec.RedirectURL"})
						} else {
							v, ok := tf.Attrs["redirect_url"].(github_com_hashicorp_terraform_plugin_framework_types.String)
							if !ok {
								i, err := t.ValueFromTerraform(ctx, github_com_hashicorp_terraform_plugin_go_tftypes.NewValue(t.TerraformType(ctx), nil))
								if err != nil {
									diags.Append(attrWriteGeneralError{"OIDCConnectorV3.Spec.RedirectURL", err})
								}
								v, ok = i.(github_com_hashicorp_terraform_plugin_framework_types.String)
								if !ok {
									diags.Append(attrWriteConversionFailureDiag{"OIDCConnectorV3.Spec.RedirectURL", "github.com/hashicorp/terraform-plugin-framework/types.String"})
								}
